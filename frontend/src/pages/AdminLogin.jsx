          ...
          <div className="auth-form-container">
            <div className="auth-form-card">
              <div className="form-header">
                <h1 className="form-title">Admin Login to Vignan AI</h1>
                <p className="form-subtitle">Welcome back, Admin! Please sign in to access the dashboard.</p>
              </div>
              ...
              <form onSubmit={submit} className="auth-form">
                ...
                <div className="form-footer">
                  <p className="signup-link">
                    Need student access? <Link to="/login" className="link">Student Login</Link>
                  </p>
                </div>
              </form>
            </div>
